    ...
    def immediate_cost(self, B, a, B_, drate):
        ...
        for i in range(self.n_elem):
            if a[i] == 1:
                ...
                self.costs_plot[0] += -2 * self.discount_reward ** self.time_step
                ...
                cost_system += - 30
                self.costs_plot[1] += - 30 * self.discount_reward ** self.time_step
        ...
        if PfSyS_ < PfSyS:
            ...
            self.costs_plot[2] += PfSyS_ * (-50000) * self.discount_reward ** self.time_step
        else:
            cost_system += (PfSyS_ - PfSyS) * (-50000)
            self.costs_plot[2] += (PfSyS_ - PfSyS) * (-50000) * self.discount_reward ** self.time_step
